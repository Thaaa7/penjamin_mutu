          ...
          <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
            <div class="container-fluid">
              ...
              <div class="header-area text-left">
                <button class="btn btn-primary">Tambahkan Usul Kegiatan</button>
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th><strong>Status Publish</strong></th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Pendidikan</td>
                    <td><span class="badge badge-success">Dokumen telah ditindaklanjuti Penjamin Mutu</span></td>
                  ...
                  <tr>
                    ...
                    <td>Pelatihan X Akt XI Tahun 2023 Klasikal</td>
                    <td>Pendidikan</td>
                    <td><span class="badge badge-info">Dokumen Dikembalikan</span></td>
                    <td>Belum di Publish</td>
                    <td>
                      <button class="btn btn-info">Edit</button>
                      <button class="btn btn-danger">Delete</button>
                  ...
                  <tr>
                    ...
                    <td>Pelatihan X Akt XI Tahun 2023 Klasikal</td>
                    <td>Pendidikan</td>
                    <td><span class="badge badge-warning">Menunggu Verifikasi Penjamin Mutu</span></td>
                    <td>Belum di Publish</td>
                    <td>
                      <button class="btn btn-info">Edit</button>
                      <button class="btn btn-danger">Delete</button>
